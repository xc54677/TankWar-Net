...
//			audioInputStream = AudioSystem.getAudioInputStream(this.getClass().getClassLoader().getResource(fileName));
	...
	public static void main(String[] args) {
		 Audio a = new Audio("H:\\IDEAWorkSpace\\Tank\\src\\audio\\explode.wav");
